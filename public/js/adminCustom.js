$(document).ready(function () {
    ...
    $(".sidebar .sidebar-wrapper ul.nav li").each(function (index) {
...
function deleteSelectedCategory() {
    ...
    if (selected.length == 0) {
        ...
        $('#deleteCatgIds').attr("href", urls.deleteCategories + '?ids=' + searchIDs);
...
function deleteSelectedUser(id) {
    if (id) {
        $('#deleteUserId').attr("href", urls.deleteUserId + id);
